...
$agentTemp   = $html->getFile($_SERVER['DOCUMENT_ROOT'].'/tpl/account/transfer/agentTemp.html');
$memTemp     = $html->getFile($_SERVER['DOCUMENT_ROOT'].'/tpl/account/transfer/memTemp.html');
